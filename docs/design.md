...
11. **Weekly study notebook**: Engagement is shown separately from attainment. My desk keeps a concise notebook of flashcards on two separate days, one number-systems activity and one programming activity each week, plus a 4–6 mark exam-style answer every other week. Required teacher work remains the primary action, while the notebook stays visible so the pupil can understand the whole week without mistaking optional practice for required work. A teacher-set upcoming test shows its date, days remaining, included specification sections and a direct route to the test plan. The notebook has no punitive streak, leaderboard or carried backlog. Same-day flashcard repetition counts as one day; page views, examples, confidence and retries cannot inflate it. Awaiting-review exam work may be labelled submitted but cannot affect attainment.
