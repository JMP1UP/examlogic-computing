...
- **Weekly Notebook**: My desk shows a calm weekly notebook beneath the primary task: flashcards on two different calendar days, number-systems practice, programming and (on alternating weeks) one 4–6 mark exam-style answer. Required work remains the primary action, but the notebook stays visible and clearly says that required work comes first. Each task links directly to the relevant activity. If a teacher has set a test, the nearest test is shown with its date, days remaining, included specification sections and a direct link to the test plan. Only recorded learner activity satisfies notebook items; a class-wide assignment status is not treated as an individual completion record. A new week starts clean with no punitive streak or overdue optional backlog. Engagement status never changes mastery.
