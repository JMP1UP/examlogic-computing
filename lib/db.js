...
let mockStore = {
  ...
  identity_providers: [
    ...
    { id: 'idp_pwd', school_id: 'school_1', provider: 'password', display_name: 'StudySpice pilot account', enabled: true, created_at: new Date().toISOString(), updated_at: new Date().toISOString() }
  ]
};
